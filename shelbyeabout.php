<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="includes/about.css" />
  ...
  <body>
    ...
    <div class="about-us">
      ...
      <p>
        Our management Personel underwent a Series of Practicle Trainnings Which
        Include Travelling
      </p>
    ...
    <!---staff- 
            ...
            <div class="ceoimage">
                <img src="https://wallpapercave.com/wp/0jxCRHS.jpg">

            </div>
            <div class="developerimage">
                <img src="images/sitedeveloper.jpg">
    ...
    <div class="staff">
      <div class="Ceo">
        <h1>C E O</h1>
        <p><img src="images/tellephone.png" />: +254 718144940</p>
        <p>
          <a target="_blank" href="mailto:renieznduki940@gmail.com"
            ><img
              src="../shelbye/images/Gmail new Logo 2020.jpg"
              style="max-width: 30px" /></a
          ><a href="mailto:renieznduki940@gmail.com"> : renieznduki940@gmail.com</a>
        </p>
        <p>We work around the Clock To ensure You</p>
        <p>Get efficient services By being in touch</p>
      </div>
      <div class="site-Developer">
        <h1>Site Developer</h1>
        <p>Pelu Jeremiah</p>
        <p>CEO : Sharaz Techs</p>
        <p><img src="images/tellephone.png" />: +254 791386752</p>
        <p>
          <a target="_blank" href="mailto:pelunguta@gmail.com"
            ><img
              src="../shelbye/images/Gmail new Logo 2020.jpg"
              style="max-width: 30px" /></a
          ><a href="mailto:pelunguta@gmail.com"> : pelunguta@gmail.com</a>
        </p>
        <p>We work around the Clock To ensure You</p>
        <p>Get efficient services By being in touch</p>
      </div>
    ...
    <div class="footer">
      ...
      <div class="About">
        ...
        <p>to Product specialization ,Products purchasing $ Supply</p>
        <p>
          Services is Constantly Upgrading and acquiring new Skills to Ensure
        </p>
        <p>We can Serve Our customers Better.</p>
        <p>
          Our management Personel underwent a Series of Practicle Trainnings
          Which
        </p>
        <p>
          Include Travelling technical trainning and Obtained Several
          certification
        </p>
      </div>
      <div class="icons">
