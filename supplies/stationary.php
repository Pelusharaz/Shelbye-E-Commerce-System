<?php
 ...
 if (isset($_POST['submit'])){
  ...
  $email = $_POST['email3'];
  $orders = $_POST['orders3'];
  $location = $_POST['location3'];
 
  try {
    //code...
    $sql = 'INSERT INTO stationaryorders(email3, orders3 , location3 ) VALUES(?,?,?)';
    $sth = $DBH->prepare($sql);
...
<html>
    ...
    <body>
        ...
        <div class="images">
            <img src="../images/stationary1.jpg"style="max-width:450px;">
            <img src="../images/stationary2.png"style="max-width:450px;">
            <img src="../images/stationary3.jpg"style="max-width:460px;"> 
        </div>
        ...
        <script>
            ...
            <div class="form-container">
                <div class="container">
                    <form action="../supplies/stationary.php" method="POST" id="order"style="display:none;" >
                        <h1>Order Now!</h1>
                        <hr>
                        <label for="email"><b>Email</b></label>
                        <input type="text" placeholder="Enter Email" name="email3" id="email" required>
                        <label for="Order"><b>Enter order Description</b></label>
                        <input type="text" placeholder="Enter order" name="orders3" id="order" required>
                        <label for="Location"><b>Enter Known Location</b></label>
                        <input type="text" placeholder="Enter location" name="location3" id="location" required>
                        <hr>
