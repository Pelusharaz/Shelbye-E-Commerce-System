<?php
 ...
 if (isset($_POST['submit'])){
  ...
  try {
    //code...
    $sql = 'INSERT INTO brandingorders(email, orders , location ) VALUES(?,?,?)';
    $sth = $DBH->prepare($sql);
...
<html>
  ...
  <body>
    ...
    <div class="images">
      <img src="../images/branding3.jpg" style="max-width: 450px" />
      <img src="../images/branding1.jpg"style="max-width: 450px"/>
      <img src="../images/branding2.jpg" style="max-width: 450px" />
    </div>
    ...
    <div class="form-container">
      <div class="container">
        <form action="../supplies/branding.php" method="POST" id="order"style="display:none;" >
            <h1>Order Now!</h1>
            <hr>
            <label for="email"><b>Email</b></label>
            <input type="text" placeholder="Enter Email" name="email" id="email" required>
            <label for="Order"><b>Enter order Description</b></label>
            <input type="text" placeholder="Enter order" name="orders" id="order" required>
      ...
      <div class="button">
        <button type="submit" class="orderbtn" ; onclick="Openform();">
          CLICK TO ORDER!
        </button>
      </div>
    </div>
